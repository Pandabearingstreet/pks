...
#' else zero.
#' @param beta,eta,pi vectors of parameter values for probabilities of careless
#' errors, lucky guesses, and knowledge states, respectively.
#' @param file_name name of an output file.
#' @return A list having the following components: \item{NItems}{the number of
#' items.} \item{NStates}{the number of knowledge states.} \item{NPar}{the
#' number of parameters.} \item{Rank}{the rank of the Jacobian matrix.}
#' \item{NSD}{the null space dimension.} \item{RankBeta, RankEta, RankPi,
#' RankBetaEta, RankBetaPi, RankEtaPi}{the rank of submatrices of the
#' Jacobian.} \item{DiagBetaEta, DiagBetaPi, DiagEtaPi,
#' DiagBetaEtaPi}{diagnostic information about specific parameter trade-offs.}
#' \item{Jacobian}{the Jacobian matrix.} \item{beta, eta, pi}{the parameter
#' values used in the analysis.}
#' @seealso \code{\link{blim}}, \code{\link{jacobian}}.
#' @references Stefanutti, L., Heller, J., Anselmi, P., & Robusto, E. (2012).
